...
public class TreadmillTest {
    public static void main(String[] args) {
       ...
       Treadmill d = new Treadmill("4号",2016,"某某某",26,"black","2016-1",2222);
        ...
        for (Treadmill treadmill : treadmills) {
            System.out.println(treadmill.getBrand()+" | "+treadmill.getPublishTime()+" | "+treadmill.getMaterial()+" | "+treadmill.getFloorSpace()+" | "+treadmill.getColor()+ " | "+treadmill.getProductCode()+" | "+treadmill.getPower());
        }
